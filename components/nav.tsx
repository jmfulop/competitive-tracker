...
import { TrendingUp, Radio, Edit2, GitCompare, CreditCard, Trophy, Activity, Sun, Moon, Download } from 'lucide-react';
import { useState, useEffect } from 'react';
import { createClient } from '@/lib/supabase/client';

const NAV_ITEMS = [
  { href: '/tracker',     label: 'Dashboard',   icon: <TrendingUp size={15} /> },
  ...
  { href: '/win-loss',    label: 'Win / Loss',  icon: <Trophy size={15} />      },
